...
public class VR_s12R_Edge : MonoBehaviour
{
    ...
    int[][] edges = new int[][]
    {
        new int[] { 0, 3 }, new int[] { 3, 11 },
        new int[] { 0, 11 }, new int[] { 11, 4 },
        new int[] { 0, 4 }, new int[] { 4, 5 },
        ...
        new int[] { 11, 19 },
        new int[] { 4, 19 }, new int[] { 19, 12 },
        new int[] { 4, 12 }, new int[] { 12, 13 }, new int[] { 13, 5 },
        new int[] { 13, 6 },
        new int[] { 13, 14 },
        new int[] { 6, 14 }, new int[] { 14, 15 }, new int[] { 15, 7 },
        new int[] { 15, 8 },
        new int[] { 15, 16 },
        new int[] { 8, 16 }, new int[] { 16, 17 }, new int[] { 17, 9 },
        new int[] { 17, 10 },
        new int[] { 17, 18 },
        new int[] { 10, 18 }, new int[] { 18, 19 },
        new int[] { 19, 23 },
        new int[] { 12, 23 }, new int[] { 23, 20 },
        new int[] { 12, 20 }, new int[] { 20, 13 },
        new int[] { 20, 14 },
        new int[] { 20, 21 },
        new int[] { 14, 21 }, new int[] { 21, 15 },
        new int[] { 21, 16 },
        new int[] { 21, 22 },
        new int[] { 16, 22 }, new int[] { 22, 17 },
        new int[] { 22, 18 },
        new int[] { 22, 23 },
        new int[] { 18, 23 },
    };
